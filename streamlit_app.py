...
def get_fruityvice_data(this_fruit_choice):
  ...
  fruityvice_normalized = pandas.json_normalize(fruityvice_response.json()) #normalize json output
...
try:
  ...
  if not fruit_choice:
    ...
    streamlit.dataframe(back_from_function) #output it as table
...
if streamlit.button('Add a fruit to the list'):
  my_cnx = snowflake.connector.connect(**streamlit.secrets["snowflake"])
  back_from_fuction = insert_row_snowflake(add_fruit)
  my_cnx.close()
